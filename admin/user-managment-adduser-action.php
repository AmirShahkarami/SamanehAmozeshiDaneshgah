...
if ((empty($username)) || (empty($password)) || (empty($role))) {
    header("location:user-managment-adduser.php");
}

$sql = "INSERT INTO `user` (`user_code`, `username`, `password`, `role`) VALUES (NULL, '$username', '$password', '$role')";
...
if ($conn->query($sql) === TRUE) {
    ...
    <strong>موفقیت آمیز!</strong> کاربر جدید با موفقیت ثبت شد.
  </div>";
} else {
    $alert .= "
